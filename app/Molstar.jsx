/*
Adapted from https://github.com/samirelanduk/molstar-react
With tweaks added to work with latest Molstar release
*/
...
const Molstar = props => {
    ...
    const { useInterface, pdbId, url, file, dimensions, className, showControls, showAxes, onLoad } = props;
        ...
        if (plugin) {
            ...
            if (file) {
                ...
                try {
                    ...
                    console.log("render error caught")
                }
            }
        }
    }
